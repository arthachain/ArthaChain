...
# Artha Chain Single-Node Testnet Management Script
...
function print_help {
    echo "Artha Chain Single-Node Testnet Management Script"
    echo ""
    echo "Usage: $0 [command]"
    echo ""
    echo "Commands:"
    echo "  start        Start the single-node testnet"
...
function start_testnet {
    echo "Starting Artha Chain single-node testnet..."
