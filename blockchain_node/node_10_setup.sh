#!/bin/bash
echo "🚀 Setting up ArthaChain Node 10"
...
sed -i 's/port=30303/port=303010/' arthachain_node.py
sed -i 's/api_port=8080/api_port=80810/' arthachain_node.py

# Start node
echo "🔗 Starting ArthaChain Node 10"
echo "📡 P2P Port: 303010"
echo "🌐 API Port: 80810"
