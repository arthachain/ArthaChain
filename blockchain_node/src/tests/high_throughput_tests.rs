...
mod tests {
    ...
    fn test_parallel_processing_capacity() {
        ...
        println!("Starting parallel processing test with {} threads", num_threads);
        println!("Processing {} transactions of {} bytes each", num_transactions, tx_size);
        ...
        assert!(tps > 50000.0, "Throughput below minimum requirement: {:.2} TPS", tps);
    }
} 