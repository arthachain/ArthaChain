#!/bin/bash
echo "🚀 Setting up ArthaChain Node 9"
...
sed -i 's/port=30303/port=30309/' arthachain_node.py
sed -i 's/api_port=8080/api_port=8089/' arthachain_node.py

# Start node
echo "🔗 Starting ArthaChain Node 9"
echo "📡 P2P Port: 30309"
echo "🌐 API Port: 8089"
