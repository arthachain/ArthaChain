#!/bin/bash
echo "🚀 Setting up ArthaChain Node 3"
...
sed -i 's/port=30303/port=30303/' arthachain_node.py
sed -i 's/api_port=8080/api_port=8083/' arthachain_node.py

# Start node
echo "🔗 Starting ArthaChain Node 3"
echo "📡 P2P Port: 30303"
echo "🌐 API Port: 8083"
