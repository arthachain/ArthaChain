#!/bin/bash
echo "🚀 Setting up ArthaChain Node 5"
...
sed -i 's/port=30303/port=30305/' arthachain_node.py
sed -i 's/api_port=8080/api_port=8085/' arthachain_node.py

# Start node
echo "🔗 Starting ArthaChain Node 5"
echo "📡 P2P Port: 30305"
echo "🌐 API Port: 8085"
