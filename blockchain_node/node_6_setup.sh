#!/bin/bash
echo "🚀 Setting up ArthaChain Node 6"
...
sed -i 's/port=30303/port=30306/' arthachain_node.py
sed -i 's/api_port=8080/api_port=8086/' arthachain_node.py

# Start node
echo "🔗 Starting ArthaChain Node 6"
echo "📡 P2P Port: 30306"
echo "🌐 API Port: 8086"
