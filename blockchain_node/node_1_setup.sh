#!/bin/bash
echo "🚀 Setting up ArthaChain Node 1"
...
sed -i 's/port=30303/port=30301/' arthachain_node.py
sed -i 's/api_port=8080/api_port=8081/' arthachain_node.py

# Start node
echo "🔗 Starting ArthaChain Node 1"
echo "📡 P2P Port: 30301"
echo "🌐 API Port: 8081"
